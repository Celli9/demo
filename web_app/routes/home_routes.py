...
# the reason we split our routes between init and home_routes --> don't want it all in one place. This is more modular
# and organized. The init is like boiler plate, this can be more specific
